...
import normalExerciseModalContent from './normalExerciseModalContent';
import videoExerciseModalContent from './videoExerciseModalContent';

export default function exerciseModal(index: number, exercise: ExerciseType, loggedInImageUploadSecion = false) {
  return (
    /* html */
    `<div
